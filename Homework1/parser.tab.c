...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_tokenList = 18,                 /* tokenList  */
...
static const char *const yytname[] =
{
  ...
  "NEQ", "LEQ", "GEQ", "ASGN", "ADDASGN", "$accept", "tokenList", "token", YY_NULLPTR
};
...
{
       0,     4,     5,     6,     7,     8,    17,     9,    10,    11,
      12,    13,    14,    15,    16,     0,     3,     1,     2
};
...
yyreduce:
  ...
  case 4: /* token: ID  */
#line 41 "parser.y"
                                {printf("Line %d Token: %s Value: %s\n", (yyvsp[0].tokenData)->linenum, (yyvsp[0].tokenData)->tokenID, (yyvsp[0].tokenData)->tokenStrInput);}
#line 1112 "parser.tab.c"
    break;

  case 5: /* token: NUMCONST  */
#line 42 "parser.y"
                                {printf("Line %d Token: %s Value: %d  Input: %s\n", (yyvsp[0].tokenData)->linenum, (yyvsp[0].tokenData)->tokenID, (yyvsp[0].tokenData)->nvalue, (yyvsp[0].tokenData)->tokenStrInput);}
#line 1118 "parser.tab.c"
    break;

  case 6: /* token: CHARCONST  */
#line 43 "parser.y"
                                {printf("Line %d Token: %s Value: \'%c\'  Input: %s\n", (yyvsp[0].tokenData)->linenum, (yyvsp[0].tokenData)->tokenID, (yyvsp[0].tokenData)->cvalue, (yyvsp[0].tokenData)->tokenStrInput);}
#line 1124 "parser.tab.c"
    break;

  case 7: /* token: STRINGCONST  */
#line 44 "parser.y"
                                {printf("Line %d Token: %s Value: \"%s\"  Len: %d  Input: %s\n", (yyvsp[0].tokenData)->linenum, (yyvsp[0].tokenData)->tokenID, (yyvsp[0].tokenData)->svalue, (yyvsp[0].tokenData)->strLength, (yyvsp[0].tokenData)->tokenStrInput);}
...
#line 1136 "parser.tab.c"
  ...
  case 9: /* token: KEYWORD  */
#line 46 "parser.y"
                                {printf("Line %d Token: %s\n", (yyvsp[0].tokenData)->linenum, (yyvsp[0].tokenData)->tokenID);}
