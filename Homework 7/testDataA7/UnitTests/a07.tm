...
* File compiled:  ./testDataA7/UnitTests/a07.tm
* 
* ** ** ** ** ** ** ** ** ** ** ** **
* FUNCTION input
...
* CALL EXPRESSION
* CALL outnl
 51:     ST  1,-3(1)	3 Store fp in ghost frame for outnl
* Param end outnl
...
* CALL EXPRESSION
* CALL output
 56:     ST  1,-4(1)	1 Store fp in ghost frame for output
* Param 1
 57:     LD  3,-2(1)	2 Load variable y
 58:     ST  3,-6(1)	Push parameter 
* Param end output
 59:    LDA  1,-4(1)	1 Ghost frame becomes new active frame 
...
* CALL EXPRESSION
* CALL outnl
 63:     ST  1,-4(1)	3 Store fp in ghost frame for outnl
* Param end outnl
