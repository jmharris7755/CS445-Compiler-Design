...
* File compiled:  ./testDataA7/UnitTests/e03.tm
* 
* ** ** ** ** ** ** ** ** ** ** ** **
* FUNCTION input
...
* OP EXPRESSION
 ...
 43:     ST  3,-3(1)	Push the left side 
...
* CALL EXPRESSION
* CALL output
 49:     ST  1,-4(1)	1 Store fp in ghost frame for output
* Param 1
* TOFF: -6
 50:     LD  3,-2(1)	2 Load variable x
 51:     ST  3,-6(1)	Push parameter 
* Param end output
 52:    LDA  1,-4(1)	1 Ghost frame becomes new active frame 
...
* ASSIGNMENT EXPRESSION
* OP EXPRESSION
 57:     LD  3,-2(1)	2 Load variable x
 58:     ST  3,-4(1)	Push the left side 
 59:    LDC  3,1(6)	Load Integer constant 
 60:     LD  4,-4(1)	Load Left into 1 
 61:    ADD  3,4,3	Op + +
 62:     ST  3,-2(1)	Store variable x
* Compound Body
* TOFF:  -3
* END COMPOUND
 63:    JMP  7,-22(7)	go to the beginning of the loop 
...
* OP EXPRESSION
 ...
 67:     ST  3,-3(1)	Push the left side 
 68:    LDC  3,10(6)	Load Integer constant 
 69:     LD  4,-3(1)	Load Left into 1 
 70:    TLT  3,4,3	Op < <
...
* CALL EXPRESSION
* CALL output
 73:     ST  1,-4(1)	1 Store fp in ghost frame for output
* Param 1
* TOFF: -6
 74:     LD  3,-2(1)	2 Load variable x
 75:     ST  3,-6(1)	Push parameter 
* Param end output
 76:    LDA  1,-4(1)	1 Ghost frame becomes new active frame 
...
* ASSIGNMENT EXPRESSION
* OP EXPRESSION
 81:     LD  3,-2(1)	2 Load variable x
 82:     ST  3,-4(1)	Push the left side 
 83:    LDC  3,1(6)	Load Integer constant 
 84:     LD  4,-4(1)	Load Left into 1 
 85:    ADD  3,4,3	Op + +
 86:     ST  3,-2(1)	Store variable x
* Compound Body
* TOFF:  -3
* END COMPOUND
 87:    JMP  7,-22(7)	go to the beginning of the loop 
