...
* OP EXPRESSION
 42:     LD  3,-2(1)	Load address of base of array 543 s
 43:     LD  3,1(3)	Load array size 669 
...
* CALL EXPRESSION
* CALL outputc
 53:     ST  1,-6(1)	1 Store fp in ghost frame for outputc
* Param 1
* TOFF: -7
* TOFF: -8
* OP EXPRESSION
 54:     LD  3,-2(1)	2 Load address of base of array 583 s
 55:     ST  3,-8(1)	Push left side 
* TOFF: -9
 56:     LD  3,-3(1)	1 load variable 851 i
* TOFF: -8
 57:     LD  4,-8(1)	1 Pop left into ac1 
 58:    SUB  3,4,3	1 Compute location from index 
 59:     LD  3,0(3)	1 Load array element 
 60:     ST  3,-8(1)	Push parameter 1001 
* Param end outputc
 61:    LDA  1,-6(1)	1 Ghost frame becomes new active frame 
 62:    LDA  3,1(7)	Return address in ac 
 63:    JMP  7,-36(7)	CALL OUTPUT outputc
...
* CALL EXPRESSION
* CALL outputs
 75:     ST  1,-2(1)	1 Store fp in ghost frame for outputs
* Param 1
* TOFF: -3
* TOFF: -3
  1:    LIT  "dogs are super cool!"
 76:    LDA  3,-1(0)	Load address of char array 
 77:     ST  3,-4(1)	Push parameter 1001 
* Param end outputs
 78:    LDA  1,-2(1)	1 Ghost frame becomes new active frame 
 79:    LDA  3,1(7)	Return address in ac 
 80:    JMP  7,-42(7)	CALL OUTPUT outputs
 81:    LDA  3,0(2)	Save the result in ac 
* CALL end outputs
* TOFF: -2
* CALL EXPRESSION
* CALL outnl
 82:     ST  1,-2(1)	3 Store fp in ghost frame for outnl
* Param end outnl
 83:    LDA  1,-2(1)	Ghost frame becomes new active frame 
 84:    LDA  3,1(7)	Return address in ac 
 85:    JMP  7,-52(7)	CALL OUTPUT outnl
 86:    LDA  3,0(2)	Save the result in ac 
* CALL end outnl
* TOFF: -2
* CALL EXPRESSION
* CALL outputs
 87:     ST  1,-2(1)	1 Store fp in ghost frame for outputs
* Param 1
* TOFF: -3
* TOFF: -3
...
* Param end outputs
 ...
 92:    JMP  7,-54(7)	CALL OUTPUT outputs
...
* CALL EXPRESSION
* CALL outnl
101:     ST  1,-2(1)	3 Store fp in ghost frame for outnl
* Param end outnl
