...
* File compiled:  ./testDataA7/UnitTests/v04.tm
* 
* ** ** ** ** ** ** ** ** ** ** ** **
* FUNCTION input
...
* COMPOUND
* TOFF:  -36
 83:    LDC  3,9(6)	load array size 124 a
 ...
 91:    LDC  3,3(6)	load array size 124 b
 92:     ST  3,-12(1)	save array size b
 11:    LIT  "bat"
 ...
 99:    LDC  3,5(6)	load array size 124 h
100:     ST  3,-16(1)	save array size h
 15:    LIT  "horse"
...
108:     ST  3,-22(1)	save array size big
109:    LDC  3,2(6)	load array size 124 small
110:     ST  3,-33(1)	save array size small
* ASSIGNMENT EXPRESSION
...
* CALL EXPRESSION
* CALL outputs
117:     ST  1,-36(1)	1 Store fp in ghost frame for outputs
* Param 1
* TOFF: -38
* TOFF: -38
118:    LDA  3,-34(1)	2 Load address of base of array 783 small
* TOFF: -38
119:     ST  3,-38(1)	Push parameter 1001 
* Param end outputs
120:    LDA  1,-36(1)	1 Ghost frame becomes new active frame 
...
* CALL EXPRESSION
* CALL outnl
124:     ST  1,-36(1)	3 Store fp in ghost frame for outnl
* Param end outnl
...
* CALL EXPRESSION
* CALL outputs
135:     ST  1,-36(1)	1 Store fp in ghost frame for outputs
* Param 1
* TOFF: -38
* TOFF: -38
136:    LDA  3,-23(1)	2 Load address of base of array 783 big
* TOFF: -38
137:     ST  3,-38(1)	Push parameter 1001 
* Param end outputs
138:    LDA  1,-36(1)	1 Ghost frame becomes new active frame 
...
* CALL EXPRESSION
* CALL outnl
142:     ST  1,-36(1)	3 Store fp in ghost frame for outnl
* Param end outnl
...
* CALL EXPRESSION
* CALL outnl
147:     ST  1,-36(1)	3 Store fp in ghost frame for outnl
* Param end outnl
...
* TOFF: -36
* ASSIGNMENT EXPRESSION
152:    LDA  3,-13(1)	Load address of char array b
...
* CALL EXPRESSION
* CALL outputs
158:     ST  1,-36(1)	1 Store fp in ghost frame for outputs
* Param 1
* TOFF: -38
* TOFF: -38
159:    LDA  3,-34(1)	2 Load address of base of array 783 small
* TOFF: -38
160:     ST  3,-38(1)	Push parameter 1001 
* Param end outputs
161:    LDA  1,-36(1)	1 Ghost frame becomes new active frame 
...
* CALL EXPRESSION
* CALL outnl
165:     ST  1,-36(1)	3 Store fp in ghost frame for outnl
* Param end outnl
...
* TOFF: -36
* ASSIGNMENT EXPRESSION
170:    LDA  3,-13(1)	Load address of char array b
...
* CALL EXPRESSION
* CALL outputs
176:     ST  1,-36(1)	1 Store fp in ghost frame for outputs
* Param 1
* TOFF: -38
* TOFF: -38
177:    LDA  3,-23(1)	2 Load address of base of array 783 big
* TOFF: -38
178:     ST  3,-38(1)	Push parameter 1001 
* Param end outputs
179:    LDA  1,-36(1)	1 Ghost frame becomes new active frame 
...
* CALL EXPRESSION
* CALL outnl
183:     ST  1,-36(1)	3 Store fp in ghost frame for outnl
* Param end outnl
...
* CALL EXPRESSION
* CALL outnl
188:     ST  1,-36(1)	3 Store fp in ghost frame for outnl
* Param end outnl
...
* TOFF: -36
* ASSIGNMENT EXPRESSION
193:    LDA  3,-17(1)	Load address of char array h
...
* CALL EXPRESSION
* CALL outputs
199:     ST  1,-36(1)	1 Store fp in ghost frame for outputs
* Param 1
* TOFF: -38
* TOFF: -38
200:    LDA  3,-34(1)	2 Load address of base of array 783 small
* TOFF: -38
201:     ST  3,-38(1)	Push parameter 1001 
* Param end outputs
202:    LDA  1,-36(1)	1 Ghost frame becomes new active frame 
...
* CALL EXPRESSION
* CALL outnl
206:     ST  1,-36(1)	3 Store fp in ghost frame for outnl
* Param end outnl
...
* TOFF: -36
* ASSIGNMENT EXPRESSION
211:    LDA  3,-17(1)	Load address of char array h
...
* CALL EXPRESSION
* CALL outputs
217:     ST  1,-36(1)	1 Store fp in ghost frame for outputs
* Param 1
* TOFF: -38
* TOFF: -38
218:    LDA  3,-23(1)	2 Load address of base of array 783 big
* TOFF: -38
219:     ST  3,-38(1)	Push parameter 1001 
* Param end outputs
220:    LDA  1,-36(1)	1 Ghost frame becomes new active frame 
...
* CALL EXPRESSION
* CALL outnl
224:     ST  1,-36(1)	3 Store fp in ghost frame for outnl
* Param end outnl
...
* CALL EXPRESSION
* CALL outnl
229:     ST  1,-36(1)	3 Store fp in ghost frame for outnl
* Param end outnl
