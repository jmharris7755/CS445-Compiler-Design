...
* TOFF: -20
 ...
 67:    LDA  5,-3(0)	Load address of base of array 458 x
 68:    SUB  5,5,4	Compute offset of value 
 69:     LD  4,0(5)	Load LHS variable 499 
 70:    ADD  3,4,3	Op +=
 71:     ST  3,0(5)	Store variable x
* CALL EXPRESSION
* CALL output
 72:     ST  1,-20(1)	1 Store fp in ghost frame for output
* Param 1
* TOFF: -21
* TOFF: -22
* OP EXPRESSION
 73:    LDA  3,-3(1)	2 Load address of base of array 587 x
 74:     ST  3,-22(1)	Push left side 
* TOFF: -23
 75:    LDC  3,5(6)	Load Integer constant 
* TOFF: -22
 76:     LD  4,-22(1)	1 Pop left into ac1 
 77:    SUB  3,4,3	1 Compute location from index 
 78:     LD  3,0(3)	1 Load array element 
 79:     ST  3,-22(1)	Push parameter 1001 
* Param end output
 80:    LDA  1,-20(1)	1 Ghost frame becomes new active frame 
...
* ASSIGNMENT EXPRESSION
 ...
 85:     ST  3,-20(1)	Push index 446 
* TOFF: -21
 86:    LDA  3,-3(0)	Load address of base of array 446 x
...
* TOFF: -20
 ...
 93:    LDA  5,-11(0)	Load address of base of array 458 y
 94:    SUB  5,5,4	Compute offset of value 
 95:     LD  4,0(5)	Load LHS variable 499 
 96:    SUB  3,4,3	Op -=
 97:     ST  3,0(5)	Store variable y
* CALL EXPRESSION
* CALL output
 98:     ST  1,-20(1)	1 Store fp in ghost frame for output
* Param 1
* TOFF: -21
* TOFF: -22
* OP EXPRESSION
 99:    LDA  3,-11(1)	2 Load address of base of array 587 y
100:     ST  3,-22(1)	Push left side 
* TOFF: -23
101:    LDC  3,7(6)	Load Integer constant 
* TOFF: -22
102:     LD  4,-22(1)	1 Pop left into ac1 
103:    SUB  3,4,3	1 Compute location from index 
104:     LD  3,0(3)	1 Load array element 
105:     ST  3,-22(1)	Push parameter 1001 
* Param end output
106:    LDA  1,-20(1)	1 Ghost frame becomes new active frame 
107:    LDA  3,1(7)	Return address in ac 
108:    JMP  7,-103(7)	CALL OUTPUT output
109:    LDA  3,0(2)	Save the result in ac 
* CALL end output
* TOFF: -20
* CALL EXPRESSION
* CALL outnl
110:     ST  1,-20(1)	3 Store fp in ghost frame for outnl
* Param end outnl
111:    LDA  1,-20(1)	Ghost frame becomes new active frame 
112:    LDA  3,1(7)	Return address in ac 
113:    JMP  7,-80(7)	CALL OUTPUT outnl
